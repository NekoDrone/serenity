//when setting up, rename this file to 'local.js', and insert your keys accordingly.
...
export const gapi_key = "insert gapi key here";
export const gcal_id = "insert gcal id here";